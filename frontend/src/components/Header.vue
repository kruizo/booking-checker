<template>
  <header class="shadow-sm w-full bg-white border-gray-200 border-b">
    <div class="max-w-dvw mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-6 h-full w-full">
      <div class="px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        <div class="flex justify-between gap-8 w-full items-center">
          <RouterLink to="/">
          ...
          <div class="flex gap-4 items-center">
            ...
            <div v-else class="relative">
              ...
              >
                ...
                <div class="block w-full px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors text-sm text-left">
                    <RouterLink
                      to="/bookings"
                    >
                      📅 My Bookings
